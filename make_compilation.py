...
def makeCompilation(path = "./",
    ...
    #print(description)
    # Create compilation
    finalClip.write_videofile(outputFile, threads=1, temp_audiofile=audio_path, remove_temp=True, codec="libx264", audio_codec="mp3")

    return description
    
if __name__ == "__main__":
    makeCompilation(path = "./DankMemes_MAY_2021_V28/",
                    introName = "",
                    outroName = '',
                    totalVidLength = 10*60,
                    maxClipLength = 5,
